"""Regression checks for the apex-chain-oracle-flow casebook."""
...
from casebook.harness import assert_expected, apex_chain_oracle_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apex_chain_oracle_flow_summary(), assert_expected())
